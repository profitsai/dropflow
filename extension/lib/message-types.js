...
// === Boost Content Script Messages ===
export const END_LOW_PERFORMING_ITEMS = 'END_LOW_PERFORMING_ITEMS';
export const SELL_SIMILAR_ENDED_ITEMS = 'SELL_SIMILAR_ENDED_ITEMS';
export const SUBMIT_BULK_EDIT_FORM = 'SUBMIT_BULK_EDIT_FORM';
export const REVISE_ITEMS = 'REVISE_ITEMS';
export const COUNT_MENU_OPTIONS = 'COUNT_MENU_OPTIONS';
export const CLICK_MENU_OPTION = 'CLICK_MENU_OPTION';
export const SEND_WATCHER_OFFERS = 'SEND_WATCHER_OFFERS';
export const REVIEW_PENDING_OFFERS = 'REVIEW_PENDING_OFFERS';
...
export const DOWNLOAD_EBAY_CSV = 'DOWNLOAD_EBAY_CSV';
export const IMPORT_CSV_PRODUCTS = 'IMPORT_CSV_PRODUCTS';
export const CSV_IMPORT_PROGRESS = 'CSV_IMPORT_PROGRESS';
export const CSV_IMPORT_COMPLETE = 'CSV_IMPORT_COMPLETE';

// === Tab-Based Checking (EcomSniper-inspired) ===
export const PAUSE_MONITOR = 'PAUSE_MONITOR';
export const RESUME_MONITOR = 'RESUME_MONITOR';
export const MONITOR_PAUSED = 'MONITOR_PAUSED';
export const SCRAPE_AMAZON_TAB = 'SCRAPE_AMAZON_TAB';
export const GET_AMAZON_DATA = 'GET_AMAZON_DATA';
export const AMAZON_DATA_RESULT = 'AMAZON_DATA_RESULT';
...
export const TRACKING_PROGRESS = 'TRACKING_PROGRESS';
export const TRACKING_LOG = 'TRACKING_LOG';
export const TRACKING_STATUS = 'TRACKING_STATUS';
export const GET_TRACKER_SETTINGS = 'GET_TRACKER_SETTINGS';
export const SAVE_TRACKER_SETTINGS = 'SAVE_TRACKER_SETTINGS';
export const START_TRACKING_PAGE = 'START_TRACKING_PAGE';
export const TRACKING_PAGE_RESULT = 'TRACKING_PAGE_RESULT';
export const UPDATE_TRACKER_POSITION = 'UPDATE_TRACKER_POSITION';
